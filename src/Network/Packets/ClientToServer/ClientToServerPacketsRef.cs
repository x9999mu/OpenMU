...
/// </summary>
public readonly ref struct ServerPlayerListRequestRef
{
    private readonly Span<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="ServerPlayerListRequestRef"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public ServerPlayerListRequestRef(Span<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private ServerPlayerListRequestRef(Span<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Span of bytes to a <see cref="ServerPlayerListRequest"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator ServerPlayerListRequestRef(Span<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="ServerPlayerListRequest"/> to a Span of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Span<byte>(ServerPlayerListRequestRef packet) => packet._data; 
}
