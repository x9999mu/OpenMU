...
#pragma warning restore SA1600
    ...
    internal void AddClientMasterSkillsAndDefinitions()
    {
        ...
        this.EnsurePassiveSkill(SkillNumber.StaminaIncrease, "Stamina Increase", CharacterClasses.AllMastersExceptFistMaster, 17);
        this.EnsurePassiveSkill(SkillNumber.AgilityIncrease, "Agility Increase", CharacterClasses.AllMastersExceptFistMaster, 17);
        this.EnsurePassiveSkill(SkillNumber.StrengthIncrease, "Strength Increase", CharacterClasses.AllMastersExceptFistMaster, 17);
        this.EnsurePassiveSkill(SkillNumber.WingofStormDefPowUp, "Wing of Storm Defense Increase", CharacterClasses.BladeMaster, 17);
        this.EnsurePassiveSkill(SkillNumber.WingofStormAttPowUp, "Wing of Storm Attack Increase", CharacterClasses.BladeMaster, 17);
        this.EnsurePassiveSkill(SkillNumber.MaximumAgIncrease, "Maximum AG Increase", CharacterClasses.AllMastersExceptFistMaster, 8);
        this.EnsurePassiveSkill(SkillNumber.EternalWingsDefPowUp, "Eternal Wings Defense Increase", CharacterClasses.GrandMaster, 17);
        this.EnsurePassiveSkill(SkillNumber.EternalWingsAttPowUp, "Eternal Wings Attack Increase", CharacterClasses.GrandMaster, 17);
        this.EnsurePassiveSkill(SkillNumber.IllusionWingsDefPowUp, "Illusion Wings Defense Increase", CharacterClasses.HighElf, 17);
        this.EnsurePassiveSkill(SkillNumber.IllusionWingsAttPowUp, "Illusion Wings Attack Increase", CharacterClasses.HighElf, 17);
        this.EnsurePassiveSkill(SkillNumber.DimensionWingsDefPowUp, "Dimension Wings Defense Increase", CharacterClasses.DimensionMaster, 17);
        this.EnsurePassiveSkill(SkillNumber.DimensionWingsAttPowUp, "Dimension Wings Attack Increase", CharacterClasses.DimensionMaster, 17);
        this.EnsurePassiveSkill(SkillNumber.WingofRuinDefPowUp, "Wing of Ruin Defense Increase", CharacterClasses.DuelMaster, 17);
        this.EnsurePassiveSkill(SkillNumber.WingofRuinAttPowUp, "Wing of Ruin Attack Increase", CharacterClasses.DuelMaster, 17);
        this.EnsurePassiveSkill(SkillNumber.EmperorCapeDefPowUp, "Emperor Cape Defense Increase", CharacterClasses.LordEmperor, 17);
        this.EnsurePassiveSkill(SkillNumber.EmperorCapeAttPowUp, "Emperor Cape Attack Increase", CharacterClasses.LordEmperor, 17);
        this.EnsurePassiveSkill(SkillNumber.Inccritdamagerate, "Increase Critical Damage Rate", CharacterClasses.AllMastersExceptFistMaster, 7);
        this.EnsurePassiveSkill(SkillNumber.RestoresallMana, "Restore Full Mana", CharacterClasses.AllMastersExceptFistMaster, 1);
        this.EnsurePassiveSkill(SkillNumber.RestoresallHp, "Restore Full Life", CharacterClasses.AllMastersExceptFistMaster, 1);
        this.EnsurePassiveSkill(SkillNumber.Incexcdamagerate, "Increase Excellent Damage Rate", CharacterClasses.AllMastersExceptFistMaster, 1);
        this.EnsurePassiveSkill(SkillNumber.Incdoubledamagerate, "Increase Double Damage Rate", CharacterClasses.AllMastersExceptFistMaster, 1);
        this.EnsurePassiveSkill(SkillNumber.MaximumWizardryInc, "Maximum Wizardry Increase", CharacterClasses.GrandMaster | CharacterClasses.DuelMaster, 3);
        this.EnsurePassiveSkill(SkillNumber.MaximumAttPowerInc, "Maximum Attack Power Increase", CharacterClasses.HighElf, 3);
        this.EnsurePassiveSkill(SkillNumber.MaximumWizCurseInc, "Maximum Wizardry/Curse Increase", CharacterClasses.DimensionMaster, 3);
        ...
        this.AddPassiveMasterSkillDefinition(SkillNumber.IncreaseEnergy, Stats.TotalEnergy, AggregateType.AddRaw, Formula120, 1, 1);
        this.AddPassiveMasterSkillDefinition(SkillNumber.IncreaseHp, Stats.TotalVitality, AggregateType.AddRaw, Formula120, 1, 1);
        this.AddPassiveMasterSkillDefinition(SkillNumber.IncreaseAgility, Stats.TotalAgility, AggregateType.AddRaw, Formula120, 1, 1);
        ...
        this.AddPassiveMasterSkillDefinition(SkillNumber.ArmorSetBonusInc, Stats.DefenseFinal, AggregateType.AddFinal, Formula120, 1, 1);
        this.AddPassiveMasterSkillDefinition(SkillNumber.Vengeance, Stats.FullyReflectDamageAfterHitChance, AggregateType.AddRaw, Formula120Value, 1, 1, SkillNumber.ArmorSetBonusInc);
        this.AddPassiveMasterSkillDefinition(SkillNumber.EnergyIncrease, Stats.TotalEnergy, AggregateType.AddRaw, Formula120, 1, 1);
        this.AddPassiveMasterSkillDefinition(SkillNumber.StaminaIncrease, Stats.TotalVitality, AggregateType.AddRaw, Formula120, 1, 1);
        this.AddPassiveMasterSkillDefinition(SkillNumber.AgilityIncrease, Stats.TotalAgility, AggregateType.AddRaw, Formula120, 1, 1);
        this.AddPassiveMasterSkillDefinition(SkillNumber.StrengthIncrease, Stats.TotalStrength, AggregateType.AddRaw, Formula120, 1, 1);
        this.AddPassiveMasterSkillDefinition(SkillNumber.WingofStormDefPowUp, Stats.DefenseFinal, AggregateType.AddFinal, Formula120, 1, 1);
        this.AddPassiveMasterSkillDefinition(SkillNumber.WingofStormAttPowUp, Stats.MaximumPhysBaseDmg, AggregateType.AddRaw, Formula502, 1, 1, SkillNumber.WingofStormDefPowUp);
        this.AddPassiveMasterSkillDefinition(SkillNumber.MaximumAgIncrease, Stats.MaximumAbility, AggregateType.AddRaw, Formula120, 1, 2, SkillNumber.MaximumManaIncrease);
        this.AddPassiveMasterSkillDefinition(SkillNumber.EternalWingsDefPowUp, Stats.DefenseFinal, AggregateType.AddFinal, Formula120, 1, 1);
        this.AddPassiveMasterSkillDefinition(SkillNumber.EternalWingsAttPowUp, Stats.MaximumWizBaseDmg, AggregateType.AddRaw, Formula502, 1, 1, SkillNumber.EternalWingsDefPowUp);
        this.AddPassiveMasterSkillDefinition(SkillNumber.IllusionWingsDefPowUp, Stats.DefenseFinal, AggregateType.AddFinal, Formula120, 1, 1);
        this.AddPassiveMasterSkillDefinition(SkillNumber.IllusionWingsAttPowUp, Stats.MaximumPhysBaseDmg, AggregateType.AddRaw, Formula502, 1, 1, SkillNumber.IllusionWingsDefPowUp);
        this.AddPassiveMasterSkillDefinition(SkillNumber.DimensionWingsDefPowUp, Stats.DefenseFinal, AggregateType.AddFinal, Formula120, 1, 1);
        this.AddPassiveMasterSkillDefinition(SkillNumber.DimensionWingsAttPowUp, Stats.WizardryAndCurseBaseDmgBonus, AggregateType.AddRaw, Formula502, 1, 1, SkillNumber.DimensionWingsDefPowUp);
        this.AddPassiveMasterSkillDefinition(SkillNumber.WingofRuinDefPowUp, Stats.DefenseFinal, AggregateType.AddFinal, Formula120, 1, 1);
        this.AddPassiveMasterSkillDefinition(SkillNumber.WingofRuinAttPowUp, Stats.MaximumPhysBaseDmg, AggregateType.AddRaw, Formula502, 1, 1, SkillNumber.WingofRuinDefPowUp);
        this.AddPassiveMasterSkillDefinition(SkillNumber.EmperorCapeDefPowUp, Stats.DefenseFinal, AggregateType.AddFinal, Formula120, 1, 1);
        this.AddPassiveMasterSkillDefinition(SkillNumber.EmperorCapeAttPowUp, Stats.MaximumPhysBaseDmg, AggregateType.AddRaw, Formula502, 1, 1, SkillNumber.EmperorCapeDefPowUp);
        this.AddPassiveMasterSkillDefinition(SkillNumber.Inccritdamagerate, Stats.CriticalDamageBonus, AggregateType.AddRaw, Formula120Value, 1, 3);
        this.AddPassiveMasterSkillDefinition(SkillNumber.RestoresallMana, Stats.FullyRecoverManaAfterHitChance, AggregateType.AddRaw, Formula120Value, 1, 3);
        this.AddPassiveMasterSkillDefinition(SkillNumber.RestoresallHp, Stats.FullyRecoverHealthAfterHitChance, AggregateType.AddRaw, Formula120Value, 1, 3);
        this.AddPassiveMasterSkillDefinition(SkillNumber.Incexcdamagerate, Stats.ExcellentDamageBonus, AggregateType.AddRaw, Formula120Value, 1, 3, SkillNumber.Inccritdamagerate);
        this.AddPassiveMasterSkillDefinition(SkillNumber.Incdoubledamagerate, Stats.DoubleDamageChance, AggregateType.AddRaw, Formula120Value, 1, 3);
        this.AddPassiveMasterSkillDefinition(SkillNumber.MaximumWizardryInc, Stats.MaximumWizBaseDmg, AggregateType.AddRaw, Formula502, 1, 3, SkillNumber.MinimumWizardryInc);
        this.AddPassiveMasterSkillDefinition(SkillNumber.MaximumAttPowerInc, Stats.MaximumPhysBaseDmg, AggregateType.AddRaw, Formula502, 1, 3, SkillNumber.MinimumAttPowerInc);
        this.AddPassiveMasterSkillDefinition(SkillNumber.MaximumWizCurseInc, Stats.WizardryAndCurseBaseDmgBonus, AggregateType.AddRaw, Formula502, 1, 3, SkillNumber.MinimumWizCurseInc);
    }
