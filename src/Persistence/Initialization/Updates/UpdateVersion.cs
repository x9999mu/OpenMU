...
public enum UpdateVersion
{
    ...
    /// <summary>
    /// The version of the <see cref="ConfigureInstantServerUpdatePlugIn"/>.
    /// </summary>
    ConfigureInstantServer = 115,
    ...
    /// <summary>
    /// The version of the <see cref="RepairPotionGirlStoreUpdatePlugIn"/>.
    /// </summary>
    RepairPotionGirlStore = 141,
